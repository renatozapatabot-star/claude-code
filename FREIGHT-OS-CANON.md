...
> **v3.8 — deep-research loop-until-dry (savage-rated) + 8 real code bugs found and fixed with
...
> trust: **8 real, verified code bugs fixed, each with a regression test that would have caught it**
